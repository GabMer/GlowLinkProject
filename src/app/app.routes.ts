...
export const routes: Routes = [
  ...
  },
  {
    path: "light-control",
    loadComponent: () =>
      import("./pages/light-control/light-control.page").then(
        (m) => m.LightControlPage
      ),
    canActivate: [AuthGuard],
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("./pages/selected-lights/selected-lights.page").then(
        (m) => m.SelectedLightsPage
      ),
    canActivate: [AuthGuard],
  },
  {
    path: "music-sync",
    loadComponent: () =>
      import("./pages/music-sync/music-sync.page").then(
        (m) => m.MusicSyncPage
      ),
    canActivate: [AuthGuard],
  },
  {
    path: "preset-modes",
    loadComponent: () =>
      import("./pages/preset-modes/preset-modes.page").then(
        (m) => m.PresetModesPage
      ),
    canActivate: [AuthGuard],
  },
  {
    path: "room-player/:id",
    loadComponent: () =>
      import("./pages/room-player/room-player.page").then(
        (m) => m.RoomPlayerPage
      ),
  },
  {
    ...
    loadComponent: () =>
      import("./pages/waiting-room/waiting-room.page").then(
        (m) => m.WaitingRoomPage
      ),
  },
